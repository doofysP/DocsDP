export function metadata() {
    return [
      ["meta", { property: "theme-color", content: "#3094f2" }],
      [
        "meta",
        {
          property: "og:image",
          content:
            "https://raw.githubusercontent.com/doofysP/DocsDP/main/docs/public/DP.png",
        },
      ],
  ...
  export function socials() {
    return [
      ...
      { icon: "youtube", link: "https://www.youtube.com/@xdoofy92" },
      { icon: "github", link: "https://github.com/doofysP/DocsDP" },
      {
        icon: {
